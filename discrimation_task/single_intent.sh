...
# 路径配置
EXPLICIT_INPUT="./benchmark_dataset/explicit_preference/single_testset.json"
IMPLICIT_INPUT="./benchmark_dataset/implicit_preference/single_testset.json"
...
OUTPUT_DIR="./eval8/eval_mcq/${PERSONA}/${PROMPT}"
...
# 运行 Python 主脚本
python3 discrimation_task/eval_single.py \
    --model_key "$MODEL_KEY" \
